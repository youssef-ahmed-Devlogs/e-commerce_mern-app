    ...
    <main className="home-page">
      ...
      <Container className="mt-5">
        <div className="section-head text-center">
          <h1 className="title m-0">Shop Now</h1>
          <p className="text">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos dolorem
            fugit accusamus perferendis a dolore repudiandae quidem voluptas
            deserunt, vel corporis odio delectus, voluptatibus facilis
            reprehenderit alias dolorum pariatur cumque!
          </p>
        </div>
